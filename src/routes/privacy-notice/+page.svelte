...
<div class="flex flex-col max-w-screen-lg container pt-32 pb-24 md:pb-40">
	...
	<div class="mb-4">
		...
		<ul>
			...
			<li>
				...
				including IP address, browser type, pages visited, and time spent on our website.
			</li>
			<li>
				Cookies and Similar Technologies: We use cookies and similar tracking technologies to
				enhance your experience on our website and analyze site usage.
			</li>
		</ul>
	</div>
	...
	<p class="mb-4">
		...
		contact us at <span class="font-medium">admin@2077.xyz</span>.
	</p>

	<h2 class="text-2xl font-semibold mb-4">Changes to This Policy</h2>
	<p class="mb-4">
		We may update this Privacy Policy from time to time. The most current version will be posted on
