...
<div class="min-h-screen text-white">
    <header class="text-center py-16">
        ...
        />
        <h1 class="text-4xl font-bold mb-8">Ethereum Navigator</h1>
        ...
        {#if hasPosts}
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {#each filteredPosts as post}
                    <article class="group bg-zinc-900/50 hover:bg-zinc-800/50 transition-colors rounded-lg overflow-hidden">
                        <a href={`/ethereum-navigator/${post.slug}`} class="block">
                            ...
                            <div class="p-6">
                                ...
                                <h3 class="text-xl font-bold mb-2 group-hover:text-teal-400 transition-colors line-clamp-2">
                                    {post.title}
                                </h3>
