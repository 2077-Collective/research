...
<div class="flex max-md:flex-col max-md:gap-8 bg-black">
	<div
		class="max-w-full w-[650px] flex-shrink-0 testimonial-home-bg bg-[#0C0C0D] flex items-center justify-center text-center"
	>
		<h3 class="text-[58.676px] leading-[52.222px] font-bold font-powerGroteskBold">
			WHAT THE <br /> PEOPLE ARE <br /> SAYING <br /> ABOUT US
		</h3>
	</div>

	<div class="md:flex-1 max-md:w-full pt-32 pb-24 overflow-hidden">
		<div class="relative">
			<Carousel.Root bind:api class="w-full relative" opts={{ loop: true, align: 'center' }}>
				<AnimateSharedLayout>
					<Carousel.Content class="-mx-20 md:-mx-[121px]">
						{#each testimonials as testimonial, i}
							<Carousel.Item class="flex-none w-[271px] md:w-[330px] p-2 ml-8">
