...
<div class="flex flex-col lg:flex-row w-full">
    ...
    <div class="flex flex-col gap-3 md:gap-6 w-full lg:w-2/6 p-6 md:p-10 text-base bg-secondary max-md:px-5 max-md:max-w-full">
        ...
        <a href={`/${article.slug}`}>
            <h1 class="font-powerGroteskBold text-xl sm:text-3xl lg:text-5xl font-medium text-white leading-tight tracking-tight">
