...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    acknowledgement: Schema.Attribute.Text;
    article_status: Schema.Attribute.Enumeration<['draft', 'ready']>;
    ...
    gpt_summary: Schema.Attribute.Text;
    is_sponsored: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
    > &
      Schema.Attribute.Private;
    min_read: Schema.Attribute.Integer;
    ...
    related_articles: Schema.Attribute.Relation<
      ...
      'api::article.article'
    >;
    scheduled_publish_time: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
    sponsor_color: Schema.Attribute.String;
    sponsor_text_color: Schema.Attribute.String;
    summary: Schema.Attribute.Text;
    table_of_contents: Schema.Attribute.JSON;
    thumb: Schema.Attribute.Media<'images' | 'files'>;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    twitter_username: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
